...
var vec__47803 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__47806 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47806,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47806,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47803,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47803,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__47809){
var vec__47810 = p__47809;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47810,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47810,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47813,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47813,(1),null);
...
var vec__47817 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47817,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47817,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47817,(2),null);
var vec__47820 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47820,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47820,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47820,(2),null);
...
var G__47823 = special_option;
var G__47823__$1 = (((G__47823 instanceof cljs.core.Keyword))?G__47823.fqn:null);
switch (G__47823__$1) {
case "explain":
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__47824){
var vec__47825 = p__47824;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47825,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47825,(1),null);
...
var G__47918 = (i__4731__auto___47916 + (1));
i__4731__auto___47916 = G__47918;
continue;
} else {
}
break;
...
var vec__47831 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47831,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47831,(1),null);
...
var G__47834 = zprint.core.parse_string_all_options(rest_options);
var G__47835 = zprint.core.czprint_str_internal;
var G__47836 = ":parse-string-all? call";
var G__47837 = (function (){var G__47838 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__47838) : zprint.zutil.edn_STAR_.call(null,G__47838));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__47834,G__47835,G__47836,G__47837) : zprint.core.process_multiple_forms.call(null,G__47834,G__47835,G__47836,G__47837));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__47839 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47839,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47839,(1),null);
...
/** @this {Function} */
zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq47828){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47829,G__47830,seq47828__$2);
});
...
var args__4736__auto__ = [];
var len__4730__auto___47920 = arguments.length;
var i__4731__auto___47921 = (0);
while(true){
if((i__4731__auto___47921 < len__4730__auto___47920)){
args__4736__auto__.push((arguments[i__4731__auto___47921]));

var G__47922 = (i__4731__auto___47921 + (1));
i__4731__auto___47921 = G__47922;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq47844){
var G__47845 = cljs.core.first(seq47844);
var seq47844__$1 = cljs.core.next(seq47844);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47845,seq47844__$1);
});
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq47846){
var G__47847 = cljs.core.first(seq47846);
var seq47846__$1 = cljs.core.next(seq47846);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47847,seq47846__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___47928 = arguments.length;
var i__4731__auto___47929 = (0);
while(true){
if((i__4731__auto___47929 < len__4730__auto___47928)){
args__4736__auto__.push((arguments[i__4731__auto___47929]));

var G__47930 = (i__4731__auto___47929 + (1));
i__4731__auto___47929 = G__47930;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq47848){
var G__47849 = cljs.core.first(seq47848);
var seq47848__$1 = cljs.core.next(seq47848);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47849,seq47848__$1);
});
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq47850){
var G__47851 = cljs.core.first(seq47850);
var seq47850__$1 = cljs.core.next(seq47850);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47851,seq47850__$1);
});
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__47861,form){
var vec__47862 = p__47861;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47862,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47862,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47862,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47862,(3),null);
...
var vec__47865 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47865,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47865,(1),null);
...
var forms = (function (){var G__47870 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__47870) : zprint.zutil.edn_STAR_.call(null,G__47870));
})();
