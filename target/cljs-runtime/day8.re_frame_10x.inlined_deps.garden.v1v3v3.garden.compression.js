 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v3.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v3$garden$compression$token_fn(p__42490){
var vec__42491 = p__42490;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42491,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42491,(1),null);
return ((function (vec__42491,tag,re){
return (function (s){
...
var G__42514 = (i__4731__auto___42513 + (1));
i__4731__auto___42513 = G__42514;
continue;
} else {
}
break;
...
return (p1__42494_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__42494_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__42494_SHARP_.call(null,s));
});})(fs))
,fs);
});
;})(fs))
...
/** @this {Function} */
day8.re_frame_10x.inlined_deps.garden.v1v3v3.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq42495){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq42495));
});
...
var map__42507 = temp__5733__auto__;
var map__42507__$1 = (((((!((map__42507 == null))))?(((((map__42507.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42507.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42507):map__42507);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42507__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42507__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42507__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__42522 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__42523 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__42510 = tag;
