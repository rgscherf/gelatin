...
var G__46682 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__46682;
continue;
} else {
var G__46683 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__46683;
continue;
}
} else {
var G__46684 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__46684;
continue;
}
}
...
var G__46676 = zloc;
var G__46677 = (function (){var G__46678 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__46679 = zloc;
var G__46679__$1 = (((G__46679 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__46679) : rewrite_clj.zip.node.call(null,G__46679)));
if((G__46679__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__46679__$1) : zprint.zutil.edn_STAR_.call(null,G__46679__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__46678) : rewrite_clj.zip.root.call(null,G__46678));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__46676,G__46677) : rewrite_clj.zip.replace.call(null,G__46676,G__46677));
});
/**
...
var G__46685 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__46685;
continue;
}
break;
...
var G__46686 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__46687 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__46686;
out = G__46687;
continue;
} else {
...
var G__46688 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__46689 = cljs.core.next(new_loc);
var G__46690 = replaced_loc;
nloc = G__46688;
new_loc = G__46689;
last_loc = G__46690;
continue;
...
return zprint.rewrite.sort_val((function (){var G__46680 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__46680) : rewrite_clj.zip.down.call(null,G__46680));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__46681_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__46681_SHARP_) : rewrite_clj.zip.tag.call(null,p1__46681_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__46681_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__46681_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
