...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__46936_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__46936_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__46936_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__46937){
var vec__46938 = p__46937;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46938,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46938,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__46941,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46942__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46942__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46942__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__46952 = (function (){var or__4131__auto__ = color;
...
var fexpr__46951 = (function (){var G__46953 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__46953) : style_map.call(null,G__46953));
})();
return (fexpr__46951.cljs$core$IFn$_invoke$arity$1 ? fexpr__46951.cljs$core$IFn$_invoke$arity$1(G__46952) : fexpr__46951.call(null,G__46952));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__46954){
var vec__46955 = p__46954;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46955,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46955,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46955,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__46958){
var vec__46959 = p__46958;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46959,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46959,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46959,(2),null);
...
var G__47210 = cljs.core.next(ssv);
var G__47211 = (this_ssv == null);
var G__47212 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__47213 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__47210;
doing_nil_QMARK_ = G__47211;
last_elide = G__47212;
out = G__47213;
continue;
}
...
var vec__46968 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46968,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46968,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46968,(2),null);
...
var G__47214 = cljs.core.next(remaining_cvec);
var G__47215 = new_idx;
var G__47216 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__47214;
idx = G__47215;
out = G__47216;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__46984,cursor_vec){
var vec__46985 = p__46984;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46985,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46985,(1),null);
var focus_vec = vec__46985;
...
var vec__46988 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46988,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46988,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__46993){
var vec__46994 = p__46993;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46994,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46994,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__47001,existing_count){
var vec__47002 = p__47001;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47002,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47002,(1),null);
...
return cljs.core.filterv(((function (s__$1,len,cursor__$1,vec__47002,s,cursor){
return (function (p1__46997_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__46997_SHARP_))));
});})(s__$1,len,cursor__$1,vec__47002,s,cursor))
...
var vec__47143 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47143,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47143,(1),null);
var cvec_element = vec__47143;
if((cvec_element == null)){
var G__47245 = cljs.core.next(cvec_nl);
var G__47246 = (idx + (1));
var G__47247 = start;
var G__47248 = out;
cvec_nl = G__47245;
...
var G__47258 = cljs.core.next(cvec_nl);
var G__47259 = (idx + (1));
var G__47260 = idx;
var G__47261 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__47258;
idx = G__47259;
start = G__47260;
out = G__47261;
...
var G__47262 = cljs.core.next(cvec_nl);
var G__47263 = (idx + (1));
var G__47264 = (idx + (1));
var G__47265 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__47262;
idx = G__47263;
start = G__47264;
out = G__47265;
...
var G__47266 = cljs.core.next(cvec_nl);
var G__47267 = (idx + (1));
var G__47268 = idx;
var G__47269 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__47266;
idx = G__47267;
start = G__47268;
out = G__47269;
...
var G__47270 = cljs.core.next(cvec_nl);
var G__47271 = (idx + (1));
var G__47272 = start;
var G__47273 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__47270;
idx = G__47271;
start = G__47272;
out = G__47273;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__47151_SHARP_,p2__47150_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__47150_SHARP_)){
return cljs.core.reduced(p1__47151_SHARP_);
} else {
return (p1__47151_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__47163,p__47164){
var vec__47165 = p__47163;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47165,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47165,(1),null);
var vec__47168 = p__47164;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47168,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47168,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__47180,cvec,focus_vec){
var map__47187 = p__47180;
...
var options = map__47187__$1;
var map__47188 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47187__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47188__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47188__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47188__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__47187,map__47187__$1,options,map__47188,map__47188__$1,focus,lines,paths){
return (function (p1__47179_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__47179_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__47187,map__47187__$1,options,map__47188,map__47188__$1,focus,lines,paths))
,path_vecs);
