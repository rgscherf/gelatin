...
return (function() { 
var G__44672__delegate = function (args){
...
while (G__44674__i < G__44674__a.length) {G__44674__a[G__44674__i] = arguments[G__44674__i + 0]; ++G__44674__i;}
  args = new cljs.core.IndexedSeq(G__44674__a,0,null);
} 
return G__44672__delegate.call(this,args);};
G__44672.cljs$lang$maxFixedArity = 0;
G__44672.cljs$lang$applyTo = (function (arglist__44675){
...
var G__44558 = o;
(G__44558[day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.cached_custom_prop_name(k)] = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__44676__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__44676__delegate.call(this,args);};
...
return G__44676__delegate(args);
});
...
var G__44576 = props;
var G__44576__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44576,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__44576);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44576__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.stringify_class = (function day8$re_frame_10x$inlined_deps$reagent$v0v8v0$reagent$impl$template$stringify_class(p__44580){
...
var props = map__44581__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44581__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.input_node_set_value = (function day8$re_frame_10x$inlined_deps$reagent$v0v8v0$reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__44591){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44592__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.batching.do_after_render(((function (node_value,map__44592,map__44592__$1,on_write){
return (function (){
...
});})(node_value,map__44592,map__44592__$1,on_write))
);
} else {
...
var G__44624 = jsprops;
(G__44624["defaultValue"] = value);

(G__44624["onChange"] = ((function (G__44624,v,value,on_change){
return (function (p1__44622_SHARP_){
return day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.input_handle_change(this$,on_change,p1__44622_SHARP_);
});})(G__44624,v,value,on_change))
);
...
var vec__44629 = cljs.core.next(cljs.core.re_matches(day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44629,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44629,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44629,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___44700 = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___44700 == null)){
} else {
var key_44701 = temp__5739__auto___44700;
(jsprops["key"] = key_44701);
}
...
var temp__5739__auto___44702 = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___44702 == null)){
} else {
var key_44703 = temp__5739__auto___44702;
day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.oset(jsprops,"key",key_44703);
}
...
var G__44640 = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.__GT_NativeWrapper();
(G__44640["name"] = c);
...
var G__44642 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__44642) : day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.as_element.call(null,G__44642));
} else {
...
/** @this {Function} */
day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq44648){
var G__44649 = cljs.core.first(seq44648);
var seq44648__$1 = cljs.core.next(seq44648);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44649,seq44648__$1);
});
...
break;
default:
var G__44724 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__44724;
continue;
...
var n__4607__auto___44738 = a.length;
var i_44739 = (0);
while(true){
if((i_44739 < n__4607__auto___44738)){
(a[i_44739] = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.as_element((a[i_44739])));

var G__44740 = (i_44739 + (1));
i_44739 = G__44740;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___44741 = a.length;
var i_44742 = (0);
while(true){
if((i_44742 < n__4607__auto___44741)){
var val_44743 = (a[i_44742]);
if(((cljs.core.vector_QMARK_(val_44743)) && ((day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.key_from_vec(val_44743) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_44742] = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.as_element(val_44743));

var G__44744 = (i_44742 + (1));
i_44742 = G__44744;
continue;
} else {
}
...
var ctx = ({});
var vec__44658 = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.ratom.check_derefs(((function (ctx){
return (function (){
return day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44658,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44658,(1),null);
...
var G__44662 = (cljs.core.count(argv) - first_child);
switch (G__44662) {
case (0):
...
case (1):
var G__44663 = comp;
var G__44664 = jsprops;
var G__44665 = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__44663,G__44664,G__44665);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__44662){
