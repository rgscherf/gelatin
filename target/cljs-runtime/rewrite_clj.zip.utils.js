...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__46416,k,f){
var vec__46417 = p__46416;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46417,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46417,(1),null);
var loc = vec__46417;
...
var G__46452 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__46452;
continue;
}
break;
...
var G__46454 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__46454;
continue;
} else {
return zloc__$1;
...
var G__46457 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__46457;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__46426){
var vec__46427 = p__46426;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46427,(0),null);
var map__46430 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46427,(1),null);
...
var path = map__46430__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46430__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__46427;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__46434){
var vec__46435 = p__46434;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46435,(0),null);
var map__46438 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46435,(1),null);
...
var path = map__46438__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46438__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__46435;
if(cljs.core.seq(r)){
...
var vec__46443 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46443,(0),null);
var map__46446 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46443,(1),null);
...
var path = map__46446__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46446__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46446__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46446__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46446__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
