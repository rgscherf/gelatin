...
var G__40451 = o;
(G__40451[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__40455 = o;
(G__40455[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__40463 = props;
var G__40463__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40463,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__40463);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40463__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__40464){
...
var props = map__40465__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40465__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__40465,map__40465__$1,props,class$){
return (function (c){
...
});})(map__40465,map__40465__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__40468){
var map__40469 = p__40468;
var map__40469__$1 = (((((!((map__40469 == null))))?(((((map__40469.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40469.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40469):map__40469);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40469__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__40469,map__40469__$1,on_write){
return (function (){
...
});})(node_value,map__40469,map__40469__$1,on_write))
);
} else {
...
var G__40473 = jsprops;
(G__40473["defaultValue"] = value);

(G__40473["onChange"] = ((function (G__40473,v,value,on_change){
return (function (p1__40472_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__40472_SHARP_);
});})(G__40473,v,value,on_change))
);
...
var vec__40477 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40477,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40477,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40477,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___40554 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___40554 == null)){
} else {
var key_40556 = temp__5739__auto___40554;
...
var temp__5739__auto___40562 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___40562 == null)){
} else {
var key_40563 = temp__5739__auto___40562;
reagent.impl.template.oset(jsprops,"key",key_40563);
}
...
var G__40482 = reagent.impl.template.__GT_NativeWrapper();
(G__40482["name"] = c);
...
var G__40483 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__40483) : reagent.impl.template.as_element.call(null,G__40483));
} else {
...
args__4736__auto__.push((arguments[i__4731__auto___40566]));

var G__40567 = (i__4731__auto___40566 + (1));
i__4731__auto___40566 = G__40567;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq40486){
var G__40487 = cljs.core.first(seq40486);
var seq40486__$1 = cljs.core.next(seq40486);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40487,seq40486__$1);
});
...
break;
default:
var G__40571 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__40571;
continue;
...
var n__4607__auto___40572 = a.length;
var i_40573 = (0);
while(true){
if((i_40573 < n__4607__auto___40572)){
(a[i_40573] = reagent.impl.template.as_element((a[i_40573])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___40575 = a.length;
var i_40576 = (0);
while(true){
if((i_40576 < n__4607__auto___40575)){
var val_40577 = (a[i_40576]);
if(((cljs.core.vector_QMARK_(val_40577)) && ((reagent.impl.template.key_from_vec(val_40577) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_40576] = reagent.impl.template.as_element(val_40577));

var G__40578 = (i_40576 + (1));
i_40576 = G__40578;
continue;
} else {
}
...
var ctx = ({});
var vec__40490 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40490,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40490,(1),null);
...
var G__40493 = (cljs.core.count(argv) - first_child);
switch (G__40493) {
case (0):
...
case (1):
var G__40494 = comp;
var G__40495 = jsprops;
var G__40496 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__40494,G__40495,G__40496);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__40493){
