...
if((i < len)){
var k = (ks[i]);
var G__40433 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__40434 = (i + (1));
m = G__40433;
i = G__40434;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__40341 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__40341);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__40343 = c;
var G__40343__$1 = (((G__40343 == null))?null:G__40343.prototype);
if((G__40343__$1 == null)){
return null;
} else {
return (G__40343__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__40345 = c;
var G__40345__$1 = (((G__40345 == null))?null:G__40345.prototype);
if((G__40345__$1 == null)){
return null;
} else {
return (G__40345__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__40454__delegate = function (args){
var G__40351 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__40351) : reagent.impl.component.as_element.call(null,G__40351));
};
...
while (G__40458__i < G__40458__a.length) {G__40458__a[G__40458__i] = arguments[G__40458__i + 0]; ++G__40458__i;}
  args = new cljs.core.IndexedSeq(G__40458__a,0,null);
} 
return G__40454__delegate.call(this,args);};
G__40454.cljs$lang$maxFixedArity = 0;
G__40454.cljs$lang$applyTo = (function (arglist__40459){
var args = cljs.core.seq(arglist__40459);
return G__40454__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__40352 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__40353 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__40353;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__40352;
}});
...
return ((function (G__40356,G__40356__$1){
...
var c = this;
var G__40367_40471 = (c["cljsRatom"]);
if((G__40367_40471 == null)){
} else {
reagent.ratom.dispose_BANG_(G__40367_40471);
}
...
var renders_40474 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_40475 = cljs.core.first(cljs.core.vals(renders_40474));
if((cljs.core.count(renders_40474) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_40474))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_40475)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_40475], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__40368 = name;
switch (G__40368) {
case "":
...
var G__40370 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__40370);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__40371 = fiber;
var G__40371__$1 = (((G__40371 == null))?null:(G__40371["type"]));
if((G__40371__$1 == null)){
return null;
} else {
return (G__40371__$1["displayName"]);
}
})();
var parent = (function (){var G__40372 = fiber;
if((G__40372 == null)){
return null;
} else {
return (G__40372["return"]);
}
})();
var path = (function (){var G__40373 = parent;
var G__40373__$1 = (((G__40373 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__40373) : reagent.impl.component.fiber_component_path.call(null,G__40373)));
if((G__40373__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40373__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4131__auto__ = (function (){var G__40375 = c;
if((G__40375 == null)){
return null;
} else {
return (G__40375["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__40376._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__40378 = c;
if((G__40378 == null)){
return null;
} else {
return (G__40378["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__40380 = c;
if((G__40380 == null)){
return null;
} else {
return G__40380._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__40386 = instance;
if((G__40386 == null)){
return null;
} else {
return (G__40386["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__40388 = instance;
if((G__40388 == null)){
return null;
} else {
return G__40388._currentElement;
}
}
})();
var name = (function (){var G__40393 = elem;
var G__40393__$1 = (((G__40393 == null))?null:(G__40393["type"]));
if((G__40393__$1 == null)){
return null;
} else {
return (G__40393__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__40402 = elem;
if((G__40402 == null)){
return null;
} else {
return (G__40402["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__40404._owner;
}
}
})();
var path = (function (){var G__40409 = owner;
var G__40409__$1 = (((G__40409 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__40409) : reagent.impl.component.component_path.call(null,G__40409)));
if((G__40409__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40409__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__40418 = c;
var G__40418__$1 = (((G__40418 == null))?null:G__40418.constructor);
if((G__40418__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__40418__$1);
}
}
})();
