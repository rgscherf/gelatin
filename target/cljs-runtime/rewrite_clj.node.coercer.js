...
var G__46145_46164 = rewrite_clj.node.protocols.coerce;
var G__46146_46165 = "object";
var G__46147_46166 = ((function (G__46145_46164,G__46146_46165){
return (function (v){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(v),v);
});})(G__46145_46164,G__46146_46165))
;
goog.object.set(G__46145_46164,G__46146_46165,G__46147_46166);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"number",true);

var G__46148_46167 = rewrite_clj.node.protocols.coerce;
var G__46149_46168 = "number";
var G__46150_46169 = ((function (G__46148_46167,G__46149_46168){
return (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(n),n);
});})(G__46148_46167,G__46149_46168))
;
goog.object.set(G__46148_46167,G__46149_46168,G__46150_46169);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"string",true);

var G__46152_46170 = rewrite_clj.node.protocols.coerce;
var G__46153_46171 = "string";
var G__46154_46172 = ((function (G__46152_46170,G__46153_46171){
return (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.stringz.string_node(n),n);
});})(G__46152_46170,G__46153_46171))
;
goog.object.set(G__46152_46170,G__46153_46171,G__46154_46172);
rewrite_clj.node.coercer.seq_node = (function rewrite_clj$node$coercer$seq_node(f,sq){
return rewrite_clj.node.coercer.node_with_meta((function (){var G__46155 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__46155) : f.call(null,G__46155));
})(),sq);
});
...
var comma_46173 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_46174 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = ((function (comma_46173,space_46174){
return (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(((function (comma_46173,space_46174){
return (function (p__46156){
var vec__46157 = p__46156;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46157,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46157,(1),null);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_46174,rewrite_clj.node.protocols.coerce(v),comma_46173], null);
});})(comma_46173,space_46174))
