...
return [(function (){var pred__40958 = cljs.core.instance_QMARK_;
var expr__40959 = reactive_val;
if(cljs.core.truth_((pred__40958.cljs$core$IFn$_invoke$arity$2 ? pred__40958.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__40959) : pred__40958.call(null,reagent.ratom.RAtom,expr__40959)))){
return "ra";
} else {
if(cljs.core.truth_((pred__40958.cljs$core$IFn$_invoke$arity$2 ? pred__40958.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__40959) : pred__40958.call(null,reagent.ratom.RCursor,expr__40959)))){
return "rc";
} else {
if(cljs.core.truth_((pred__40958.cljs$core$IFn$_invoke$arity$2 ? pred__40958.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__40959) : pred__40958.call(null,reagent.ratom.Reaction,expr__40959)))){
return "rx";
} else {
if(cljs.core.truth_((pred__40958.cljs$core$IFn$_invoke$arity$2 ? pred__40958.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__40959) : pred__40958.call(null,reagent.ratom.Track,expr__40959)))){
return "tr";
} else {
return "other";
}
