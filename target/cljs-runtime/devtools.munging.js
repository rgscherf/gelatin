...
var o39740 = temp__5733__auto__;
var temp__5733__auto____$1 = (o39740["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o39741 = temp__5733__auto____$1;
return (o39741["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__39544__auto__ = f;
return (o__39544__auto__["toString"]).call(o__39544__auto__);
} else {
return "";
}
}catch (e39750){var _ = e39750;
return "";
}});
...
try{var o__39544__auto___39885 = t;
(o__39544__auto___39885["cljs$lang$ctorPrWriter"]).call(o__39544__auto___39885,t,writer);
}catch (e39760){var __39886 = e39760;
}
...
var char_code = (function (){var o__39544__auto__ = (new String(char$));
return (o__39544__auto__["charCodeAt"]).call(o__39544__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39544__auto__ = String;
return (o__39544__auto__["fromCharCode"]).call(o__39544__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39775 = num_code;
switch (G__39775) {
case (1):
return (185);
...
var o__39544__auto__ = String;
return (o__39544__auto__["fromCharCode"]).call(o__39544__auto__,superscript_code);
});
/**
...
}catch (e39801){var _e__39551__auto__ = e39801;
return false;
}})())){
...
var vec__39802 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39802,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o39805 = temp__5733__auto__;
var temp__5733__auto____$1 = (o39805["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o39806 = temp__5733__auto____$1;
...
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39810,(0),null);
...
var G__39905 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__39906 = cljs.core.butlast(remaining_tokens);
name_tokens = G__39905;
remaining_tokens = G__39906;
continue;
}
}
break;
...
var vec__39815 = cljs.core.split_with((function (p1__39814_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__39814_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39815,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39815,(1),null);
...
var vec__39821 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39821,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39821,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__39909 = cljs.core.rest(remaining_tokens);
var G__39910 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__39909;
name_tokens = G__39910;
continue;
} else {
...
var vec__39826 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39826,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39826,(1),null);
var vec__39829 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39829,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39829,(1),null);
var vec__39832 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39832,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39832,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39832,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39832,(3),null);
...
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39839,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39839,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39839,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39839,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39839,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39839,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__39842 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39842,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39842,(1),null);
var vec__39845 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39845,(0),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__39848 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__39848) : devtools.munging.parse_fn_info_deep.call(null,G__39848));
})()));
}
} else {
return fn_info;
...
var G__39969 = (arity + (1));
var G__39970 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39850){
var vec__39851 = p__39850;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39851,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39851,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__39857_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__39858_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39861){
var vec__39862 = p__39861;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39862,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39859){
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39866__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39866__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39866__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39866__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39867 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39867,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39867,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39867,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39867,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39867,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39867,(5),null);
...
var o__39544__auto__ = f;
return (o__39544__auto__["getBasis"]).call(o__39544__auto__);
});
/**
...
}catch (e39871){var _e__39551__auto__ = e39871;
...
var G__40061 = (obj[cljs.core.first(path)]);
var G__40062 = cljs.core.rest(path);
obj = G__40061;
path = G__40062;
continue;
} else {
...
return (function (accum,p__39872){
var vec__39873 = p__39872;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39873,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39873,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39876){
var vec__39877 = p__39876;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39877,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39877,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39877,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39882,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39882,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__39882,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39880_SHARP_){
return (obj[cljs.core.first(p1__39880_SHARP_)]);
});})(name,sorted_matches,vec__39882,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
