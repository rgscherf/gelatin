...
if((c === "\n")){
var G__46212 = escape_QMARK_;
var G__46213 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__46212;
lines = G__46213;
continue;
} else {
buf.append(c);

var G__46214 = (((!(escape_QMARK_))) && ((c === "\\")));
var G__46215 = lines;
escape_QMARK_ = G__46214;
lines = G__46215;
continue;
...
var G__46206 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__46206) : rewrite_clj.node.string_node.call(null,G__46206));
});
...
var G__46207 = cljs.core.re_pattern(regex);
var G__46208 = ["#\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(regex),"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__46207,G__46208) : rewrite_clj.node.token_node.call(null,G__46207,G__46208));
});
