...
var G__39912 = devtools.prefs.pref(v);
v = G__39912;
continue;
} else {
return v;
...
}catch (e39889){var _e__39551__auto__ = e39889;
return false;
}})();
...
}catch (e39894){var _e__39551__auto__ = e39894;
return false;
}})();
...
}catch (e39896){var _e__39551__auto__ = e39896;
return false;
}}
}
});
...
var vec__39898 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39898,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39898,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39901_SHARP_);
}),template);
});
