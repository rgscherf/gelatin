...
var G__46492 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__46492__$1 = (((G__46492 == null))?null:cljs.core.iterate(((function (G__46492,n0,temp__5733__auto__){
return (function (loc){
...
});})(G__46492,n0,temp__5733__auto__))
,G__46492));
var G__46492__$2 = (((G__46492__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__46492__$1));
var G__46492__$3 = (((G__46492__$2 == null))?null:cljs.core.last(G__46492__$2));
if((G__46492__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__46492__$3);
}
} else {
return zloc;
}
...
var G__46495 = rewrite_clj.zip.move.right(v);
var G__46496 = rewrite_clj.zip.move.up(v);
loc = G__46495;
parent = G__46496;
continue;
} else {
var G__46497 = rewrite_clj.zip.move.right(v0);
var G__46498 = parent;
loc = G__46497;
parent = G__46498;
continue;
...
var G__46499 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__46500 = rewrite_clj.zip.move.up(v);
loc = G__46499;
parent = G__46500;
continue;
} else {
var G__46501 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__46502 = parent;
loc = G__46501;
parent = G__46502;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__46493 = zloc;
var G__46493__$1 = (((G__46493 == null))?null:rewrite_clj.zip.move.down(G__46493));
var G__46493__$2 = (((G__46493__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__46493__$1,k));
if((G__46493__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__46493__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__46494 = rewrite_clj.zip.move.down(zloc);
var G__46494__$1 = (((G__46494 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__46494));
if((G__46494__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__46494__$1);
}
})(),k);
}
});
